...
### Copilot Chat 명령어(Command Prompt)
#### 슬래시 명령어 (Slash Commands)
- /help : 사용 가능한 명령어 및 도움말 표시 
- /clear : 대화 기록을 초기화하거나 새로운 대화 세션을 시작 
- /new : 새로운 채팅 대화를 시작 
- /rename : 대화 세션 이름을 변경 
- /explain : 선택된 코드나 현재 파일/워크스페이스에 대해 “이 코드가 무슨 일을 하는가?” 설명 요청 
- /doc : 문서화 주석(Docstring 또는 주석) 생성 요청 
- /fix : 오류 있는 코드, 개선할 부분 있는 코드에 대해 수정 제안 요청 
- /tests : 단위 테스트(유닛 테스트) 또는 테스트 코드 생성을 요청 
- /optimize : 코드 성능 또는 구조 최적화 제안을 요청 
- /generate : 새 코드를 생성하거나 특정 기능 구현을 요청
